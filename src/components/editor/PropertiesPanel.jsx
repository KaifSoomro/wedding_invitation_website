...
export const PropertiesPanel = ({ selectedShape, onUpdate, onDelete, onDuplicate, onLayerAction }) => {
  if (!selectedShape) {
    return (
    ...
    <div className="h-full overflow-y-auto">
      <div className="p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <Button variant="outline" size="sm" onClick={() => onLayerAction?.("front")} className="w-full">
            <ArrowUp className="h-3 w-3 mr-1" />
            Front
          </Button>
          <Button variant="outline" size="sm" onClick={() => onLayerAction?.("back")} className="w-full col-span-2">
